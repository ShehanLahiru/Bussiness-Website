@include('frontend.layouts.head')
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/1.jpeg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-5">Quality Products <strong>For the Lowest Price</strong></h1>
              <p>
                <!-- <a href="#" class="btn btn-primary py-3 px-5 rounded-0">Download</a> -->
                <!-- <a href="#" class="btn btn-white btn-outline-white py-3 px-5 rounded-0">Get In Touch</a> -->
              </p>
	  ...
	  <div class="site-blocks-cover overlay" style="background-image: url(images/x.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="mb-5">Quality Products <strong>For the Lowest Price</strong></h1>
        ...
        <div class="row no-gutters align-items-stretch h-100">
          <div class="col-lg-6">
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              <div class="col-md-6 bg-image bg-sm-height" style="background-image: url('images/4.jpg');" data-aos="fade" data-aos-delay="0"></div>
              <div class="col-md-6 bg-light text">
                <div class="p-4">
                  <h2 class="h5 mb-3 text-black line-height-sm">Bingiriya Project</h2>
          ...
          <div class="col-lg-6">
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              <div class="col-md-6 bg-image order-md-2 order-lg-1 bg-sm-height" style="background-image: url('images/7.jpg');" data-aos="fade" data-aos-delay="200"></div>
              <div class="col-md-6 bg-light text order-md-1 order-lg-2">
                <div class="p-4">
                  <h2 class="h5 mb-3 text-black line-height-sm">Iron Plant Minuwangoda</h2>
          ...
          <div class="col-lg-6">
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              <div class="col-md-6 bg-image order-md-1 order-lg-2 bg-sm-height" style="background-image: url('images/8.jpg');" data-aos="fade" data-aos-delay="300"></div>
              <div class="col-md-6 bg-light text order-md-2 order-lg-1">
                <div class="p-4">
                  <h2 class="h5 mb-3 text-black line-height-sm">Jayasekara Motors Kurunegala</h2>
          ...
          <div class="col-lg-6">
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              <div class="col-md-6 bg-image order-md-2 bg-sm-height" style="background-image: url('images/x.jpg');" data-aos="fade" data-aos-delay="400"></div>
    ...
    <div class="site-footer">
      <div class="container">
          <div class="row">
            <div class="col-md-12"><h3 class="footer-heading mb-4">CONTACT INFO</h3></div>
              <div class="col-md-6">
                <p>304, <br> KANDY ROAD,<br> KURUNEGALA</p>
              </div>
              <div class="col-md-6">
                Tel. + (123) 3240-345-9348 <br>
                info.sws@youdomain.com
              </div>
            </div>
