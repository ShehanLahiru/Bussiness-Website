        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="riddle_create" method="post" action="{{ route('backend.contactDetails.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="social_media_link" class="form-control" value="{{ old('social_media_link') }}">
