        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="riddle_update" method="post" action="{{ route('backend.contactDetails.update', $contactDetail->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control" value="{{ old('email',$contactDetail->email) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="contact_no" class="form-control" value="{{ old('contact_no',$contactDetail->contact_no) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="textarea" name="address" class="form-control" value="{{ old('address',$contactDetail->address) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="textarea" name="social_media_link" class="form-control" value="{{ old('social_media_link',$contactDetail->social_media_link) }}">
